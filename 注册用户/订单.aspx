<%@ Page Language="C#" AutoEventWireup="true" CodeFile="订单.aspx.cs" Inherits="我的订单" %>
           ...
           <div id="发表" style="float:left; width:100%; height:100%; background:#FFFFFF;">
               <div id="我的导航">
                ...
                <tr>
                    ...
                    <td style="background-color:goldenrod"><p ><a href="订单.aspx" style="color:white">我的订单</a></p></td>
...
<div id="订单">
    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="线路编号" DataSourceID="SqlDataSource2" CssClass="GridViewStyle">
        <Columns>
        ...
        <HeaderStyle CssClass="GridViewHeaderStyle" />
               ...
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TravelConnectionString %>" SelectCommand="SELECT [线路编号], [名称], [出发日期], [价格], [出行人数], [天数], [评分] FROM [订单] WHERE ([用户编号] = @用户编号)">
                   <SelectParameters>
                       <asp:SessionParameter Name="用户编号" SessionField="用户编号" Type="Int32" />
                   </SelectParameters>
    </asp:SqlDataSource>
               </div>
